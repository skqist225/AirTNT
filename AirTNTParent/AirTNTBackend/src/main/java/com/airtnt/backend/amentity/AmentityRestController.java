...
public class AmentityRestController {
    ...
    @Autowired AmentityService service;
    ...
    public String save(
        ...
        @RequestParam("amentityCategory") Integer amentityCategoryId
    ) throws IOException{
        Amentity amentity;
        if(id!=null) amentity = new Amentity(id, name, description, new AmentityCategory(amentityCategoryId));
        else amentity = new Amentity(name, description, new AmentityCategory(amentityCategoryId));
