...
import com.airtnt.backend.promo.PromoRepository;
...
public class PromoRestController {
    @Autowired PromoRepository repo;
    ...
    public String checkName(@Param("id") Integer id,
        ...
        if(promo==null) return "OK";

        if(id!=null && promo.getId()==id) return "OK";
